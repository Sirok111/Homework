...
class Record {
    ...
    public Record(String name, int occurrence) {
        this.name = name;
...
public class vpr5 {
    ...
    public static List<Record> findOccurance(List<String> wordList) {
        if (wordList == null) {
            throw new IllegalArgumentException("wordList must not be null");
        }
        ...
        wordCountMap.forEach((word, count) -> records.add(new Record(word, count)));
    ...
    public static void main(String[] args) {
        ...
        List<Record> records = findOccurance(sampleList);
